<template>
    <div class="vat-container">
        <form action="" @submit.prevent="saveVendor">
            <div class="form-row">
                <label class="form-label col-1">Nazwa</label>
                <div class="form-data col-2">
                    <input v-model="vendor.name" v-validate="'required'"
            ...
            <div class="form-row">
                ...
                <div class="form-data col-2">
                    <textarea v-model="vendor.description" class="form-textarea" name="rateDescription"
                              id=""></textarea>
                </div>
            </div>
    ...
    methods: {
      saveVendor () {
        this.$validator.validateAll().then((result) => {
          if (result) {
            if (this.vendorEdit) {
              axios.put('/vendors/' + this.vendorEdit.id, {
                vendor: this.vendor,
              }).then(() => {
